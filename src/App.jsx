  ...
  return (
    <div className="page-container">
        ...
        >
          ...
          >
            <div className="flex justify-between items-center">
              ...
              <i className="fa-solid fa-comment-dots text-xl icon-gold ml-2"></i>
            </div>
          </motion.button>
        </motion.div>
        ...
        >
          ...
          >
            <div className="flex justify-between items-center">
              ...
              <i className="fa-solid fa-box-open text-xl icon-gold ml-2"></i>
            </div>
          </motion.button>
        </motion.div>
        ...
        >
          ...
          >
            <div className="flex justify-between items-center">
              ...
              <i className="fa-solid fa-trophy text-xl icon-gold ml-2"></i>
            </div>
          </motion.button>
        </motion.div>
      </div>
      ...
      <motion.footer
        ...
        className="footer-center text-sm text-[#A69076] py-4"
      >
        <p>© 2026 今日嘉奖</p>
        <p>关于 · 分享</p>
      </motion.footer>
